...
export default function AddPenaltyRules() {
    ...
    <>
      <>
        ...
        <div className="container-fluid py-5 " style={{ display: display }}>
          <div
            className="container pt-4 mt-n5 pb-3"
            style={{ boxShadow: "3px 4px 8px #2b2e4a", borderRadius: "2px" }}
          >
            <h1 className="display-4 text-uppercase text-center mb-5">
              Add <span className="text-primary">Penalty Rules</span>
            </h1>
            <div className="row">
              <div className="col-lg-10  mx-auto mb-2">
                ...
                >
                  <form onSubmit={addData}>
                    ...
                    <div>
                      <button
                        className="btn btn-primary mt-5 offset-md-4 py-3 px-5"
                        style={{
