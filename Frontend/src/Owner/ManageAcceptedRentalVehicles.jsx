...
export default function ManageAcceptedRentalVehicle() {
  ...
  const updateStatus = (id, status) => {
    ...
    apiServices
      ...
      .then((res) => {
        ...
        setTimeout(() => {
          if (status == "Completed") {
            nav("/owner/managecompletedrenting");
          }
        }, 3000);
      })
      .catch((err) => {
      ...
      <>
        ...
        <div className="container-fluid page-header">
          <h1 className="display-3 text-uppercase text-white mb-3">
            Manage Accepted Rented Vehicles
          </h1>
        ...
        <div className="container-fluid py-5">
          ...
          >
            <h1 className="display-4 text-uppercase text-center mb-5">
              Manage{" "}
              <span className="text-primary">Accepted Rented Vehicles</span>
            </h1>
            <div className="row">
              <div className="col-lg-12 mx-auto mb-2 managedata">
