...
export default function ManageCompletedRentalVehicle() {
      ...
      <>
        ...
        <div className="container-fluid page-header">
          <h1 className="display-3 text-uppercase text-white mb-3">
            Manage Completed Rented Vehicles
          </h1>
        ...
        <div className="container-fluid py-5">
          ...
          >
            <h1 className="display-4 text-uppercase text-center mb-5">
              Manage{" "}
              <span className="text-primary">Completed Rented Vehicles</span>
            </h1>
            <div className="row">
                      ...
                      <>
                        {el.status == "Completed" ? (
                          <tr>
                            ...
                            <td>
                              <Link to={"/owner/addpenalty/" + el._id}>
                                <button
