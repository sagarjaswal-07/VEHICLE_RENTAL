...
export default function ApprovedPenalties() {
  ...
  const updateStatus = (id, paymentStatus) => {
    const data = { _id: id, paymentStatus };
    apiServices
    ...
    <>
      <>
        ...
        <div className="container-fluid py-5">
          <div
            className="container-fluid mt-n5 pt-5 pb-3"
            style={{
          ...
          >
            <h1 className="display-4 text-uppercase text-center mb-5">
              View <span className="text-primary">Approved Penalties</span>
            </h1>
            <div className="row">
              <div className="col-lg-12 mx-auto mb-2 table-responsive">
                <table className="table table-bordered">
                  ...
                  <tbody>
                    {penaltyData
                      .filter((el) => el.status === "Approved") // ab saari approved penalties dikhenge
                      .map((el, index) => (
                        <tr key={el._id}>
                          <td>{index + 1}</td>
                          ...
                          <td>
                            {el.paymentStatus !== "Paid" && (
                              <button
                                ...
                                onClick={() => updateStatus(el._id, "Paid")}
                              >
                                Mark as Paid
                              </button>
                            )}
