    ...
    <div className="row pt-5">
      ...
      <div className="col-lg-3 col-md-6 mb-5">
        ...
        <div className="d-flex flex-column justify-content-start">
          <Link className="text-body mb-2" to={"/owner"}>
            <i className="fa fa-angle-right text-white mr-2" />
            Dashboard
          </Link>
          <Link className="text-body mb-2" to={"/owner/managevehicles"}>
            <i className="fa fa-angle-right text-white mr-2" />
            Manage Vehicle
          </Link>
          <Link className="text-body mb-2" to={"/owner/addvehiclesavailability"}>
            <i className="fa fa-angle-right text-white mr-2" />
            Manage Vehicle Availability
          </Link>
          <Link className="text-body mb-2" to={"/owner/viewpenaltyrules"}>
            <i className="fa fa-angle-right text-white mr-2" />
           View Penalty Rules
          </Link>
          <Link className="text-body mb-2" to={"/owner/manageapprovedpenalties"}>
            <i className="fa fa-angle-right text-white mr-2" />
           Approved Penalties
          </Link>
          <Link className="text-body" to={"/owner/profile"}>
            <i className="fa fa-angle-right text-white mr-2" />
            Profile
          </Link>
        </div>
